    ...
    <section className={`bg-popover max-w-6xl rounded-sm my-12 mx-auto py-8 lg:py-16 ${className || ''}`}>
      <div className="flex flex-col md:flex-row gap-4 max-w-4xl mx-auto px-6">
        ...
        <div className="flex justify-center items-center">
          <Image src="https://cdn.pixabay.com/photo/2016/11/29/02/07/drone-1866742_1280.jpg" alt="CTA Image" width={320} height={240} unoptimized className="aspect-[16/9] rounded-xs" />
        </div>
      </div>
    </section>
  );
